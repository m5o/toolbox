...
module ErrorMessagesHelper
  ...
  def error_messages_for(*objects)
    ...
    options[:header_message] ||= I18n.t("errors.template.header", count: objects[0].errors.size, model: objects[0].class.model_name.human, default: "Invalid Fields")
    options[:message] ||= I18n.t("errors.template.body", default: "Correct the following errors and try again.")
